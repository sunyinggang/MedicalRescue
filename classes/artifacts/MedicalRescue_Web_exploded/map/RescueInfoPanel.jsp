...
String nameSpaceId = "rescueinfo" + r.nextInt();
...
<html>
  <head>
	...
	Ext.define('map.RescueInfoPanel', {
    	        		...
    	        		if (form.form.isValid()){
			      			 Ext.MessageBox.confirm('提示', '确定保存吗？', function(btn, text) {
			 		    		if(btn == 'yes') {
			     	        		...
			     	        		form.getForm().findField('address').setValue($('#<%=nameSpaceId%>_input').val()); 
			     	        		form.getForm().submit({
	            	...
	            	Ext.Ajax.request({
						...
						success:function(o){
							...
							$("#<%=nameSpaceId%>_case1").bMap({
			            		address:ret.json.address,
			            		name: "address", //提交表单的NAME,默认为map
